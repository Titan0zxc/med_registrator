...
| ID | Функция | Статус |
|----|---------|--------|
| ФТ-1 | Приём анкеты (ФИО, полис ОМС, возраст, симптомы) + валидация входных данных | ✅ |
| ФТ-2 | Проверка полиса ОМС через InsuranceServer (HTTP GET) | ✅ |
| ФТ-3 | Классификация + маршрутизация + выдача талона | ✅ |
| ФТ-4 | Журнал обращений + статистика по периодам | ✅ |
| ФТ-5 | Обработка ошибок и отказоустойчивость | ✅ |
